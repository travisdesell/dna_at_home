...
g++ -g -rdynamic -D_DEBUG_ -O3 -Wall -Wextra motif_models.cpp sampling.cpp sequences.cpp shifting.cpp checkpoint.cpp generate_sequences.cpp ../../mersenne_twister/dSFMT.c -DDSFMT_MEXP=19937 -lm -o ../bin/generate_sequences
