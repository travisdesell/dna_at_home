...
def plot_data_stats(data, out_graph_file_name, title):
    ...
    patch = plt.Rectangle((0, 0), 0, 0, label="1 std dev range", color="blue", alpha=0.5)
    ...
    plt.plot(x_data, outer_y1_avg, lw=3, label="Mean", color="blue", ls="-")
    plt.fill_between(x_data, outer_y1_avg - outer_y1_std, outer_y1_avg + outer_y1_std, facecolor="blue", alpha=0.5, label="1 deviation range")
    plt.plot(x_data, outer_y1_min, lw=2, label="Min", color="red", ls="-")
    plt.plot(x_data, outer_y1_max, lw=2, label="Max", color="green", ls="--")
    ...
    axes_2.set_ylim(ymin=0.0, ymax=1.0)
    plt.grid(True)
    plt.xlabel("Step")
    plt.ylabel("Probability")
    ...
    plt.plot(x_data, outer_y2_avg, lw=3, label="Mean", color="blue", ls="-")
    plt.fill_between(x_data, outer_y2_avg - outer_y2_std, outer_y2_avg + outer_y2_std, facecolor="blue", alpha=0.5, label="1 deviation range")
    plt.plot(x_data, outer_y2_min, lw=2, label="Min", color="red", ls="-")
    plt.plot(x_data, outer_y2_max, lw=2, label="Max", color="green", ls="--")
    plt.subplot(211)
